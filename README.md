...
The latest version of the library is 9.7.1 (the version number of this library matches the version of `kjson` with which
...
### Gradle
```groovy
    testImplementation 'io.kjson:kjson-spring3-test:9.7.1'
```
### Gradle (kts)
```kotlin
    testImplementation("io.kjson:kjson-spring3-test:9.7.1")
